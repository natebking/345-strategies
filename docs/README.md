...
| Root `README.md` + `LICENSE` (MPL-2.0) | Both | Project overview and license |
...
| `tools/invalidation-stop.md` | Trader | Price Action Invalidation Stop Loss: the six versions, how the structural stop moves |
| `tools/powerbar.md` | Both | PowerBar: the PB-1 / PB-2 definitions and the core morphology formula |
| `../core/README.md` | Builder | `strat_core`, the portable Python definitions: bar states, combos, timeframe continuity |
